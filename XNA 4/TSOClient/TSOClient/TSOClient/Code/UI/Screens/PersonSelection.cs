...
namespace TSOClient.Code.UI.Screens
{
    ...
    public class PersonSlot
    {
        ...
        public void DisplayAvatar(Sim avatar)
        {
            ...
            var cityThumbTex = TextureUtils.Resize(GameFacade.GraphicsDevice, Texture2D.FromStream(GameFacade.GraphicsDevice, new MemoryStream(ContentManager.GetResourceFromLongID(myCity.Thumbnail))), 78, 58);
    ...
    /*public static class CityInfoExtensions
    {
        ...
        public static Texture2D GetThumbnail(this CityInfo city){
            ...
            var texture = Texture2D.FromStream(GameFacade.GraphicsDevice, File.Open(GameFacade.GameFilePath("cities\\" + mapDir + "\\thumbnail.bmp"), FileMode.Open));
