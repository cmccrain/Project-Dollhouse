...
namespace TSOClient.Code.Rendering.City
{
    public class CityGeom : IDisposable, ICityGeom
    {
        ...
        {
            VertexBuffer = new VertexBuffer(gd, typeof(TerrainVertex), TerrainVertex.SizeInBytes * Vertices.Length, BufferUsage.WriteOnly);
    ...
    public class TextureMapper
    {
        ...
        public Vector2 MapTerrain(Vector3 point)
        {
