...
namespace TSOClient.ThreeD
{
    ...
    public class UI3DView : ThreeDElement
    {
        ...
        private void GraphicsDevice_DeviceReset(object sender, EventArgs e)
        {
            ...
            m_Scene.SceneMgr.Device.RasterizerState.CullMode = CullMode.None;
        ...
        public void LoadHeadMesh(Sim Character, Outfit Outf, int SkinColor)
        {
            ...
            if (m_CurrentSims.Count > 0)
            {
                if (!m_SingleRenderer)
                {
                    ...
                    m_CurrentSims[m_CurrentSims.Count - 1].HeadTexture = Texture2D.FromStream(m_Scene.SceneMgr.Device,
                ...
                else
                {
                    ...
                    m_CurrentSims[0].HeadTexture = Texture2D.FromStream(m_Scene.SceneMgr.Device,
                        new MemoryStream(ContentManager.GetResourceFromLongID(Bnd.TextureAssetID)));
                }
            }
            else
